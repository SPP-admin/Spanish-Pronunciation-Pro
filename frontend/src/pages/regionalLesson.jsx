...
const RegionalLesson = () => {
    ...
    const generateQuestion = async () => {
        ...
        try {
            // Pick a random region from the available lessons
    ...
    const handlePlayAudio = (text) => {
        ...
        // Match accent to the correct answer
        if (currentQuestion?.correctAnswer === 'spain') {
                    ...
                    <CardContent className="p-0 flex flex-col items-center flex-grow space-y-12">
                        ...
                        <div className="text-center w-full relative">
                            <div className="flex flex-col items-center justify-center gap-8">
                                ...
                                <div className="text-4xl md:text-5xl font-black leading-tight text-[var(--text-main)] tracking-tight min-h-[160px] max-w-4xl mx-auto flex items-center justify-center transition-all duration-300 italic px-4">
                                    {isRegenerating ? (
                                        <span className="animate-pulse opacity-20 tracking-tighter uppercase text-3xl">Generating...</span>
                                    ) : (
                                        <span className="text-center">"{currentQuestion?.sentence}"</span>
                                    )}
                                </div>
                                ...
                                <div className="flex flex-wrap justify-center gap-4">
                                    <Button
                                        ...
                                        onClick={() => handlePlayAudio(currentQuestion?.sentence)}
                                    >
                                        <FaVolumeUp size={28} />
                                    </Button>
                                    ...
                                    <Button 
                                        ...
                                        className="h-20 px-8 rounded-full border-2 border-[var(--border-color)] bg-[var(--bg-main)] text-[var(--text-main)] font-black hover:border-[var(--brand-gold)] hover:text-[var(--brand-gold)] hover:bg-white/5 uppercase text-xs tracking-widest transition-all shadow-inner active:scale-95"
                                    >
